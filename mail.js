...
var hide_lbox = 'bg-pop'; // название класса для скрытия модального окна формы
var delay = 3000; // задержка исчезновения сообщения в миллисекундах (0 - не скрывать)
var redirect = 'index.html'; // страница, на котороую перейти после отправки (оставить пустым чтоб никуда не переходить)
